...
export const {
    ...
    // trustHost lets Auth.js read the X-Forwarded-Host header to detect
    // the public URL automatically. Do NOT set redirectProxyUrl here —
    // if NEXTAUTH_URL points to localhost, sign-out redirects break.
    trustHost: true,
    session: {
        strategy: 'jwt',
