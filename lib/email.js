        ...
        <div class="container">
          ...
          <div class="content">
            ...
            <div class="section">
              ...
              <div class="info-row">
                <span class="info-label">Tax (GST ${order.taxRate ?? 18}%):</span>
...
/**
 * Send custom order inquiry notification to admin
 */
export async function sendCustomOrderEmail({ name, email, phone, category, description, budget }) {
    ...
    <html>
      <head>
        <style>
          ...
          .field-value { color: #555; }
          .message-box { background: white; padding: 20px; border-radius: 8px; border: 1px solid #e5e5e5; white-space: pre-wrap; }
          .badge { display: inline-block; padding: 4px 12px; background: #D4A574; color: #1a1a1a; border-radius: 4px; font-weight: bold; font-size: 14px; }
          .footer { text-align: center; padding: 20px; color: #666; font-size: 12px; }
        </style>
      </head>
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            ` : ''}
            <div class="field-label" style="margin-bottom: 10px;">Description</div>
            <div class="message-box">${description.replace(/</g, '&lt;').replace(/>/g, '&gt;')}</div>
          </div>
          <div class="footer">
            <p>&copy; ${new Date().getFullYear()} Marmex India. All rights reserved.</p>
          </div>
  ...
  return sendEmail({
    to: ADMIN_EMAIL,
    subject: `New Custom Order: ${categoryLabels[category] || category} — ${name}`,
    html,
...
/**
 * Send custom order confirmation to the user
 */
export async function sendCustomOrderConfirmationEmail(email, name) {
  const html = `
    <!DOCTYPE html>
    <html>
      <head>
      ...
      <body>
        <div class="container">
          <div class="header">
            <h1>Your Custom Order Inquiry Received</h1>
          </div>
          <div class="content">
            <h2>Hello ${name}!</h2>
            <p>Thank you for your interest in a bespoke marble piece. We have received your inquiry and our team will review it carefully.</p>
            <p>What happens next:</p>
            <ul>
              <li>Our artisans will review your requirements within 24 hours</li>
              <li>We'll prepare a design concept and detailed quote</li>
              <li>You'll receive an email with the proposal for your approval</li>
            </ul>
  ...
  return sendEmail({
    to: email,
    subject: 'We received your custom order inquiry — Marmex India',
    html
  })
}
